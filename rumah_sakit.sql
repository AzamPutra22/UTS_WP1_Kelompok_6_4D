...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Apr 2020 pada 12.07
...
INSERT INTO `pendaftaran_pasien` (`id_pasien`, `nama_pasien`, `gender`, `umur`, `nomer_hp`, `alamat`, `keluhan`, `ruangan`, `no_ruangan`, `nama_wali`) VALUES
(19, 'Azam Putra Imanto', 'Laki-laki', 20, '085325656274', 'Pelutan-Pemalang', '-', 'Mawar', 5, 'elly iswati'),
(22, 'Fatimahtuz Zahra Meilia', 'Perempuan', 18, '1234567891011', 'Jakarta Pusat', 'Sakit', 'Merpati', 4, 'rfgrwahhrg'),
(23, 'Abizar', 'Laki-laki', 4, '085225255354', 'Pemalang', 'Panas', 'Merpati', 7, 'elly iswati');
